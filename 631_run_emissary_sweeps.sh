...
BENCH=${BENCH:-${GEM5_ROOT}/benchmarks/631/deepsjeng_s_base.mytest-m64}
BENCH_OPTIONS="${BENCH_OPTIONS:-benchmarks/631/test.txt}"
TRACE_ROOT=${TRACE_ROOT:-${GEM5_ROOT}/Trace/631_emissary_sweeps}
SUITE=${1:-all}
