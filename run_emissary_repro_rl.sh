...
RL_Q_PENALTY_WASTED_RESCUE=${RL_Q_PENALTY_WASTED_RESCUE:-0.05}
...
RL_GLOBAL_RESCUE_QUALITY_MIN_SAMPLES=${RL_GLOBAL_RESCUE_QUALITY_MIN_SAMPLES:-12}
...
RL_GLOBAL_RESCUE_SOFT_CAP_MIN_SAMPLES=${RL_GLOBAL_RESCUE_SOFT_CAP_MIN_SAMPLES:-16}
RL_GLOBAL_RESCUE_SOFT_CAP_MIN_USEFUL_PCT=${RL_GLOBAL_RESCUE_SOFT_CAP_MIN_USEFUL_PCT:-6.25}
...
run_rl_suite() {
    ...
    for seed in ${RL_SEEDS}; do
        run_emissary_case "rl/q_learning_seed_${seed}" \
            ...
            --q-learning-action-warmup-effective-epochs="${RL_ACTION_WARMUP_EFFECTIVE_EPOCHS}" \
            --q-learning-action-warmup-max-attempts="${RL_ACTION_WARMUP_MAX_ATTEMPTS}" \
            ...
            --q-penalty-wasted-rescue="${RL_Q_PENALTY_WASTED_RESCUE}" \
            ...
            --q-learning-global-rescue-soft-cap-min-samples="${RL_GLOBAL_RESCUE_SOFT_CAP_MIN_SAMPLES}" \
