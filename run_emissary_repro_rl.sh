...
RL_ACTION_ADMISSION_RATES=${RL_ACTION_ADMISSION_RATES:-0,1.5625,3.125,6.25,12.5}
RL_ACTION_PRESERVE_WAYS=${RL_ACTION_PRESERVE_WAYS:-0,1,2,3,4}
...
RL_Q_REWARD_INST_FILL_REDUCTION=${RL_Q_REWARD_INST_FILL_REDUCTION:-10.0}
RL_Q_PENALTY_INST_FILL_REGRESSION=${RL_Q_PENALTY_INST_FILL_REGRESSION:-20.0}
...
RL_Q_PENALTY_DATA_FILL=${RL_Q_PENALTY_DATA_FILL:-3.0}
