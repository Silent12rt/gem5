...
L2_SIZE=${L2_SIZE:-1048576B}
L2_ASSOC=${L2_ASSOC:-16}
L2_LRU_WAYS=${L2_LRU_WAYS:-0}
L2_PRESERVE_WAYS=${L2_PRESERVE_WAYS:-6}
...
RL_TARGET_OCCUPANCY=${RL_TARGET_OCCUPANCY:-3.0}
RL_EPSILON=${RL_EPSILON:-0.05}
...
RL_REUSE_CAP=${RL_REUSE_CAP:-1.5}
RL_ACTION_ADMISSION_RATES=${RL_ACTION_ADMISSION_RATES:-1.5625,3.125,6.25,12.5,25}
RL_ACTION_PRESERVE_WAYS=${RL_ACTION_PRESERVE_WAYS:-1,2,3,4,6}
...
RL_Q_REWARD_PRESERVE_HIT=${RL_Q_REWARD_PRESERVE_HIT:-0.15}
RL_Q_PENALTY_ADMITTED_PRESERVE=${RL_Q_PENALTY_ADMITTED_PRESERVE:-1.5}
...
RL_Q_PENALTY_PRESERVE_OCCUPANCY=${RL_Q_PENALTY_PRESERVE_OCCUPANCY:-1.0}
RL_Q_PENALTY_INST_FILL=${RL_Q_PENALTY_INST_FILL:-0.5}
RL_Q_PENALTY_DATA_FILL=${RL_Q_PENALTY_DATA_FILL:-1.5}
