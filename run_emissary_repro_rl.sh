...
RL_ACTION_ADMISSION_RATES=${RL_ACTION_ADMISSION_RATES:-0,0.390625,0.78125,1.5625,3.125}
RL_ACTION_PRESERVE_WAYS=${RL_ACTION_PRESERVE_WAYS:-0,1,1,1,2}
