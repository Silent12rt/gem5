...
BENCH=${BENCH:-${GEM5_ROOT}/benchmarks/602/sgcc_base.mytest-m64}
BENCH_OPTIONS="${BENCH_OPTIONS:-benchmarks/602/t1.c -O3 -finline-limit=50000 -o benchmarks/602/t1.opts-O3_-finline-limit_50000.s}"
TRACE_ROOT=${TRACE_ROOT:-${GEM5_ROOT}/Trace/602_emissary_sweeps}
SUITE=${1:-all}
