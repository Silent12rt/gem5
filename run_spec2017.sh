...
export RL_ACTION_ADMISSION_RATES="${RL_ACTION_ADMISSION_RATES:-0,0.78125,1.5625,3.125,6.25}"
export RL_ACTION_PRESERVE_WAYS="${RL_ACTION_PRESERVE_WAYS:-0,1,1,2,3}"
export RL_Q_REWARD_NON_PRESERVE_VICTIM="${RL_Q_REWARD_NON_PRESERVE_VICTIM:-0.0}"
export RL_Q_PENALTY_PRESERVE_VICTIM="${RL_Q_PENALTY_PRESERVE_VICTIM:-8.0}"
...
export RL_Q_REWARD_INST_FILL_REDUCTION="${RL_Q_REWARD_INST_FILL_REDUCTION:-6.0}"
export RL_Q_PENALTY_INST_FILL_REGRESSION="${RL_Q_PENALTY_INST_FILL_REGRESSION:-35.0}"
...
export RL_Q_PENALTY_DATA_FILL="${RL_Q_PENALTY_DATA_FILL:-5.0}"
