...
export RL_BAD_ACTION_COOLDOWN="${RL_BAD_ACTION_COOLDOWN:-8}"
export RL_ACTION_QUALITY_GATE="${RL_ACTION_QUALITY_GATE:-1}"
export RL_ACTION_QUALITY_ALPHA="${RL_ACTION_QUALITY_ALPHA:-0.25}"
export RL_MIN_ACTION_QUALITY="${RL_MIN_ACTION_QUALITY:--0.5}"
export RL_ACTION_QUALITY_RECOVERY="${RL_ACTION_QUALITY_RECOVERY:-0.05}"
