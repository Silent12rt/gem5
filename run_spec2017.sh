...
export L2_PRESERVE_WAYS="${L2_PRESERVE_WAYS:-10}"
...
export RL_TARGET_OCCUPANCY="${RL_TARGET_OCCUPANCY:-60.0}"
export RL_EPSILON="${RL_EPSILON:-0.05}"
export RL_ALPHA="${RL_ALPHA:-0.2}"
export RL_GAMMA="${RL_GAMMA:-0.8}"
export RL_MIN_PRESERVE_WAYS="${RL_MIN_PRESERVE_WAYS:-1}"
export RL_DEFAULT_ACTION="${RL_DEFAULT_ACTION:-2}"
export RL_REUSE_CAP="${RL_REUSE_CAP:-4.0}"
export RL_ACTION_ADMISSION_RATES="${RL_ACTION_ADMISSION_RATES:-6.25,12.5,25,50,75}"
export RL_ACTION_PRESERVE_WAYS="${RL_ACTION_PRESERVE_WAYS:-4,6,8,10,10}"
export RL_Q_REWARD_NON_PRESERVE_VICTIM="${RL_Q_REWARD_NON_PRESERVE_VICTIM:-0.25}"
export RL_Q_PENALTY_PRESERVE_VICTIM="${RL_Q_PENALTY_PRESERVE_VICTIM:-6.0}"
export RL_Q_PENALTY_QUOTA_EXCEEDED="${RL_Q_PENALTY_QUOTA_EXCEEDED:-4.0}"
export RL_Q_PENALTY_SATURATION="${RL_Q_PENALTY_SATURATION:-150.0}"
export RL_Q_REWARD_PRESERVE_HIT="${RL_Q_REWARD_PRESERVE_HIT:-0.5}"
export RL_Q_PENALTY_ADMITTED_PRESERVE="${RL_Q_PENALTY_ADMITTED_PRESERVE:-0.8}"
export RL_Q_PENALTY_ADMISSION_PRESSURE="${RL_Q_PENALTY_ADMISSION_PRESSURE:-0.02}"
export RL_Q_PENALTY_PRESERVE_CLEAR="${RL_Q_PENALTY_PRESERVE_CLEAR:-1.0}"
export RL_Q_PENALTY_PRESERVE_OCCUPANCY="${RL_Q_PENALTY_PRESERVE_OCCUPANCY:-0.03}"
...
echo "  RL_Q: preserve_hit=${RL_Q_REWARD_PRESERVE_HIT}, admitted_penalty=${RL_Q_PENALTY_ADMITTED_PRESERVE}, pressure_penalty=${RL_Q_PENALTY_ADMISSION_PRESSURE}, clear_penalty=${RL_Q_PENALTY_PRESERVE_CLEAR}, occupancy_penalty=${RL_Q_PENALTY_PRESERVE_OCCUPANCY}, reuse_cap=${RL_REUSE_CAP}"
if [[ -n "${MAXINSTS}" ]]; then
