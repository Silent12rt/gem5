...
export RL_ACTION_ADMISSION_RATES="${RL_ACTION_ADMISSION_RATES:-0,1.5625,3.125,6.25,12.5}"
export RL_ACTION_PRESERVE_WAYS="${RL_ACTION_PRESERVE_WAYS:-0,1,2,3,4}"
...
export RL_Q_REWARD_INST_FILL_REDUCTION="${RL_Q_REWARD_INST_FILL_REDUCTION:-10.0}"
export RL_Q_PENALTY_INST_FILL_REGRESSION="${RL_Q_PENALTY_INST_FILL_REGRESSION:-20.0}"
...
export RL_Q_PENALTY_DATA_FILL="${RL_Q_PENALTY_DATA_FILL:-3.0}"
...
echo "  RL_Q: preserve_hit=${RL_Q_REWARD_PRESERVE_HIT}, inst_reduction_reward=${RL_Q_REWARD_INST_FILL_REDUCTION}, inst_regression_penalty=${RL_Q_PENALTY_INST_FILL_REGRESSION}, admitted_penalty=${RL_Q_PENALTY_ADMITTED_PRESERVE}, pressure_penalty=${RL_Q_PENALTY_ADMISSION_PRESSURE}, clear_penalty=${RL_Q_PENALTY_PRESERVE_CLEAR}, occupancy_penalty=${RL_Q_PENALTY_PRESERVE_OCCUPANCY}, inst_fill_penalty=${RL_Q_PENALTY_INST_FILL}, data_fill_penalty=${RL_Q_PENALTY_DATA_FILL}, reuse_cap=${RL_REUSE_CAP}, inst_baseline_alpha=${RL_INST_BASELINE_ALPHA}"
if [[ -n "${MAXINSTS}" ]]; then
