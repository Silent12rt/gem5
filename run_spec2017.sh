...
export RL_TARGET_SATURATION="${RL_TARGET_SATURATION:-20}"
export RL_EPSILON="${RL_EPSILON:-0.05}"
export RL_ALPHA="${RL_ALPHA:-0.2}"
export RL_GAMMA="${RL_GAMMA:-0.8}"
export RL_MIN_PRESERVE_WAYS="${RL_MIN_PRESERVE_WAYS:-4}"
...
export RL_Q_PENALTY_ADMITTED_PRESERVE="${RL_Q_PENALTY_ADMITTED_PRESERVE:-0.2}"
...
echo "  RL_Q: preserve_hit=${RL_Q_REWARD_PRESERVE_HIT}, admitted_penalty=${RL_Q_PENALTY_ADMITTED_PRESERVE}"
if [[ -n "${MAXINSTS}" ]]; then
