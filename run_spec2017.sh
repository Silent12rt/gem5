...
export RL_GLOBAL_RESCUE_QUALITY_MIN_SAMPLES="${RL_GLOBAL_RESCUE_QUALITY_MIN_SAMPLES:-16}"
...
export RL_GLOBAL_RESCUE_SOFT_CAP_MIN_USEFUL_PCT="${RL_GLOBAL_RESCUE_SOFT_CAP_MIN_USEFUL_PCT:-8.0}"
