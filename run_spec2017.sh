...
echo "  RL_Q: preserve_hit=${RL_Q_REWARD_PRESERVE_HIT}, admitted_penalty=${RL_Q_PENALTY_ADMITTED_PRESERVE}, pressure_penalty=${RL_Q_PENALTY_ADMISSION_PRESSURE}, reuse_cap=${RL_REUSE_CAP}"
if [[ -n "${MAXINSTS}" ]]; then
