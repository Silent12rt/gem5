...
export RL_TARGET_OCCUPANCY="${RL_TARGET_OCCUPANCY:-3.0}"
...
export RL_ACTION_ADMISSION_RATES="${RL_ACTION_ADMISSION_RATES:-1.5625,3.125,6.25,12.5,25}"
export RL_ACTION_PRESERVE_WAYS="${RL_ACTION_PRESERVE_WAYS:-1,2,3,4,6}"
...
export RL_Q_REWARD_PRESERVE_HIT="${RL_Q_REWARD_PRESERVE_HIT:-0.15}"
export RL_Q_PENALTY_ADMITTED_PRESERVE="${RL_Q_PENALTY_ADMITTED_PRESERVE:-1.5}"
...
export RL_Q_PENALTY_PRESERVE_OCCUPANCY="${RL_Q_PENALTY_PRESERVE_OCCUPANCY:-1.0}"
export RL_Q_PENALTY_INST_FILL="${RL_Q_PENALTY_INST_FILL:-0.5}"
export RL_Q_PENALTY_DATA_FILL="${RL_Q_PENALTY_DATA_FILL:-1.5}"
...
echo "  RL_Q: preserve_hit=${RL_Q_REWARD_PRESERVE_HIT}, admitted_penalty=${RL_Q_PENALTY_ADMITTED_PRESERVE}, pressure_penalty=${RL_Q_PENALTY_ADMISSION_PRESSURE}, clear_penalty=${RL_Q_PENALTY_PRESERVE_CLEAR}, occupancy_penalty=${RL_Q_PENALTY_PRESERVE_OCCUPANCY}, inst_fill_penalty=${RL_Q_PENALTY_INST_FILL}, data_fill_penalty=${RL_Q_PENALTY_DATA_FILL}, reuse_cap=${RL_REUSE_CAP}"
if [[ -n "${MAXINSTS}" ]]; then
