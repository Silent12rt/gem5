...
export RL_EPSILON="${RL_EPSILON:-0.08}"
...
export RL_Q_REWARD_PRESERVE_HIT="${RL_Q_REWARD_PRESERVE_HIT:-0.2}"
export RL_Q_PENALTY_WASTED_RESCUE="${RL_Q_PENALTY_WASTED_RESCUE:-0.2}"
