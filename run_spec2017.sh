...
# command line, for example: RL_EPSILON=0.10 bash run_spec2017.sh rl 620
export GEM5_ROOT
...
export RL_STARVE_ATLEAST="${RL_STARVE_ATLEAST:-1}"
export RL_STARVE_RANDOMNESS="${RL_STARVE_RANDOMNESS:-${PAPER_STARVE_RANDOMNESS}}"
export RL_TARGET_SATURATION="${RL_TARGET_SATURATION:-10}"
export RL_TARGET_OCCUPANCY="${RL_TARGET_OCCUPANCY:-4.0}"
export RL_EPSILON="${RL_EPSILON:-0.10}"
...
export RL_REUSE_CAP="${RL_REUSE_CAP:-32.0}"
export RL_INST_BASELINE_ALPHA="${RL_INST_BASELINE_ALPHA:-0.25}"
export RL_ACTION_ADMISSION_RATES="${RL_ACTION_ADMISSION_RATES:-0,3.125,6.25,12.5,25}"
export RL_ACTION_PRESERVE_WAYS="${RL_ACTION_PRESERVE_WAYS:-0,1,1,2,2}"
...
export RL_Q_REWARD_PRESERVE_HIT="${RL_Q_REWARD_PRESERVE_HIT:-1.0}"
export RL_Q_PENALTY_WASTED_RESCUE="${RL_Q_PENALTY_WASTED_RESCUE:-0.05}"
export RL_Q_REWARD_INST_FILL_REDUCTION="${RL_Q_REWARD_INST_FILL_REDUCTION:-8.0}"
export RL_Q_REWARD_TOTAL_FILL_REDUCTION="${RL_Q_REWARD_TOTAL_FILL_REDUCTION:-2.0}"
export RL_Q_PENALTY_INST_FILL_REGRESSION="${RL_Q_PENALTY_INST_FILL_REGRESSION:-12.0}"
export RL_Q_PENALTY_DATA_FILL_REGRESSION="${RL_Q_PENALTY_DATA_FILL_REGRESSION:-16.0}"
export RL_Q_PENALTY_TOTAL_FILL_REGRESSION="${RL_Q_PENALTY_TOTAL_FILL_REGRESSION:-8.0}"
export RL_Q_PENALTY_ADMITTED_PRESERVE="${RL_Q_PENALTY_ADMITTED_PRESERVE:-0.5}"
export RL_Q_PENALTY_ADMISSION_PRESSURE="${RL_Q_PENALTY_ADMISSION_PRESSURE:-0.005}"
export RL_Q_PENALTY_PRESERVE_CLEAR="${RL_Q_PENALTY_PRESERVE_CLEAR:-2.0}"
export RL_Q_PENALTY_PRESERVE_OCCUPANCY="${RL_Q_PENALTY_PRESERVE_OCCUPANCY:-0.5}"
export RL_Q_PENALTY_INST_FILL="${RL_Q_PENALTY_INST_FILL:-0.0}"
export RL_Q_PENALTY_DATA_FILL="${RL_Q_PENALTY_DATA_FILL:-2.0}"
export RL_FILL_REGRESSION_GUARD="${RL_FILL_REGRESSION_GUARD:-0}"
export RL_DATA_REGRESSION_GUARD="${RL_DATA_REGRESSION_GUARD:-0}"
export RL_DATA_POLLUTION_GUARD="${RL_DATA_POLLUTION_GUARD:-1}"
export RL_DATA_POLLUTION_THRESHOLD="${RL_DATA_POLLUTION_THRESHOLD:-8}"
export RL_SET_DATA_POLLUTION_FILTER="${RL_SET_DATA_POLLUTION_FILTER:-1}"
export RL_SET_DATA_POLLUTION_COOLDOWN="${RL_SET_DATA_POLLUTION_COOLDOWN:-8}"
export RL_BAD_ACTION_COOLDOWN="${RL_BAD_ACTION_COOLDOWN:-4}"
export RL_ACTION_QUALITY_GATE="${RL_ACTION_QUALITY_GATE:-0}"
export RL_ACTION_QUALITY_ALPHA="${RL_ACTION_QUALITY_ALPHA:-0.35}"
export RL_MIN_ACTION_QUALITY="${RL_MIN_ACTION_QUALITY:--0.2}"
export RL_ACTION_QUALITY_RECOVERY="${RL_ACTION_QUALITY_RECOVERY:-0.02}"
...
export RL_GLOBAL_RESCUE_QUALITY_MIN_SAMPLES="${RL_GLOBAL_RESCUE_QUALITY_MIN_SAMPLES:-12}"
...
export RL_GLOBAL_RESCUE_SOFT_CAP_MIN_SAMPLES="${RL_GLOBAL_RESCUE_SOFT_CAP_MIN_SAMPLES:-16}"
export RL_GLOBAL_RESCUE_SOFT_CAP_MIN_USEFUL_PCT="${RL_GLOBAL_RESCUE_SOFT_CAP_MIN_USEFUL_PCT:-6.25}"
export RL_GLOBAL_RESCUE_SOFT_CAP_MAX_ADMISSION_RATE="${RL_GLOBAL_RESCUE_SOFT_CAP_MAX_ADMISSION_RATE:-6.25}"
export RL_GLOBAL_RESCUE_SOFT_CAP_MAX_PRESERVE_WAYS="${RL_GLOBAL_RESCUE_SOFT_CAP_MAX_PRESERVE_WAYS:-1}"
