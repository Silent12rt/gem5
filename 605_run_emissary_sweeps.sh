...
BENCH=${BENCH:-${GEM5_ROOT}/benchmarks/605/mcf_s_base.mytest-m64}
BENCH_OPTIONS="${BENCH_OPTIONS:-benchmarks/605/inp.in}"
TRACE_ROOT=${TRACE_ROOT:-${GEM5_ROOT}/Trace/605_emissary_sweeps}
SUITE=${1:-all}
