...
BENCH=${BENCH:-${GEM5_ROOT}/benchmarks/620/omnetpp_s_base.mytest-m64}
BENCH_OPTIONS="${BENCH_OPTIONS:--c General -r 0}"
TRACE_ROOT=${TRACE_ROOT:-${GEM5_ROOT}/Trace/620_emissary_sweeps}
SUITE=${1:-all}
